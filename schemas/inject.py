...
IDP_RULES = (
    ...
    "ABSTENER (única respuesta exactamente: «No hay evidencia en el corpus para "
    "responder.» — sin cifras, sin «histórico», sin «ajustado por inflación», "
    "sin variantes) cuando la pregunta pide P&L / neto / bruto / operativo / "
    "impuesto / consolidado ATRIBUYÉNDOLO a una fuente que NO es el EEFF: "
    "(a) «del comunicado» / «del press» / «comunicado de prensa» — aunque el PDF "
    "del comunicado mencione 67.821, 21.262 millones u otras cifras de neto; "
    "esas cifras del press NO son claim EEFF y NO deben contestarse; "
    "(b) «de la presentación» / «del deck» / «de las slides» para P&L / neto / "
    "bruto / operativo / impuesto / consolidado (el deck SÍ puede responder "
    "EBITDA en millones y margen EBITDA LTM); "
    "(c) resultado neto / P&L «de la memoria». "
    "Si dudás entre citar el comunicado y abstener en un neto «del comunicado», "
    "ABSTENÉ. "
